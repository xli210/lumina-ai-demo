...
import { Sparkles, ExternalLink, Eye, EyeOff, Copy, Check } from "lucide-react";
              ...
              <div className="mb-6 rounded-2xl bg-white/5 p-5 ring-1 ring-white/10">
                ...
                <ol className="space-y-2 text-sm text-slate-400">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Sign in to your NanoPocket account at{" "}
                      <a href="/auth/login" className="text-indigo-400 underline underline-offset-2 hover:text-indigo-300">nanopocket.ai</a>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>Visit the demo server and enter the access password below</span>
                  </li>
                  <li className="flex items-start gap-2">
