    ...
    platforms: [
      {
        platform: "Windows",
        icon: Monitor,
        fileName: "NanoFacialEdit-1.0.2-release.zip",
        downloadUrl: "/api/downloads/NanoFacialEdit-1.0.2-release.zip",
        size: "2.2 MB",
      },
    ],
  },
    ...
    platforms: [
      {
        platform: "Windows",
        icon: Monitor,
        fileName: "NanoImageEdit-1.0.5-release.zip",
        downloadUrl: "/api/downloads/NanoImageEdit-1.0.5-release.zip",
        size: "2.4 MB",
      },
    ],
  },
    ...
    platforms: [
      {
        platform: "Windows",
        icon: Monitor,
        fileName: "NanoVideoEnhance-1.0.5-release.zip",
        downloadUrl: "/api/downloads/NanoVideoEnhance-1.0.5-release.zip",
        size: "9.1 MB",
      },
    ],
  },
    ...
    platforms: [
      {
        platform: "Windows",
        icon: Monitor,
        fileName: "NanoVideoGen-1.1.2-release.zip",
        downloadUrl: "/api/downloads/NanoVideoGen-1.1.2-release.zip",
        size: "2.2 MB",
      },
    ],
  },
